 ...
 * Use the {@link FragmentHomeCanjeAfiliado#newInstance} factory method to
...
public class FragmentHomeCanjeAfiliado extends Fragment {
    ...
    public FragmentHomeCanjeAfiliado() {
    ...
    public static FragmentHomeCanjeAfiliado newInstance(String param1, String param2) {
        FragmentHomeCanjeAfiliado fragment = new FragmentHomeCanjeAfiliado();
